...
public class MainFrame extends JFrame
{
  ...
  //  private JMenuItem menuFileToGraphd;
    ...
    private JMenuItem menuTableChess;
  //  private JMenuItem menuTableFind;
    ...
    public MainFrame()
    {
      ...
      //);
        ...
        menuTableChess =new JMenuItem("Сделать в виде шахмат");
        menuTableChess.addActionListener(new ActionListener()
                                          { //?
                                              public void actionPerformed(ActionEvent ev)
                                              {
                                                  renderer.setChess(true);
                                                  getContentPane().repaint();
                                              }
                                          }
        );
     ...
     //   menuFileToGraphd.setEnabled(false);
        ...
        menuTableChess.setEnabled(false);
      ...
      //  menuTable.add(menuTableFind);
        ...
        btnCalc.addActionListener(new ActionListener()
        {
          ...
          //      menuFileToGraphd.setEnabled(true);
                ...
                menuTableChess.setEnabled(true);
                renderer.setChess(false);
